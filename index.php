...
<body>
    <div class="general-content">
        <nav class="main-nav">
            <div class="logo-type-section">
                <div>
                    <h1 id="heading-title-logo">Valor economico</h1>
                    <a title="Valor economico " href="/">
                        <img src="img/logo_l.png" alt="">
                    </a>
                </div>
            </div>
            <nav class="menu">
                <ul class="menu-items">
                    <li class="menu-item active">
                        <svg class="svg-icon " width="64" height="64" viewBox="0 0 64 64" fill="none"
                            ...
                            <path class="svg-icon-i"
                                d="M40.8027 35.8506L40.8027 39.7641L36.0032 42.099L36.0032 38.0558L40.8027 35.8506Z" />
                            <path class="svg-icon-i"
                                d="M40.8026 44.4401L40.8026 46.3069L38.5131 47.4208L38.5131 45.492L40.8026 44.4401Z" />
                            <path class="svg-icon-i"
                                d="M52.7968 32.5825L52.7968 39.078L44.8307 42.9535L44.8307 36.2426L52.7968 32.5825Z" />
                        </svg>
                    ...
                    <li class="menu-item active">
                        ...
                        <span class="menu-tooltip">Histórico de pedidos</span>
                    </li>
                    <li class="menu-item">
                        <a href="#">
                            <svg viewBox="0 0 24 24">
                            ...
                            <span class="menu-tooltip">Subscrever</span>
                        </a>
                    </li>
                    <li class="menu-item ">
                        <svg viewBox="0 0 24 24">
                        ...
                        <span class="menu-tooltip">Edição imprensa</span>
                    </li>

                </ul>
                <ul>
                    <li class="menu-item  menu-avatar">
                        <img src="img/avatar.png" alt="" srcset="">
                    </li>
                    <div class="dropdown-menu">
                        <div class="block-divisor center">
                            <span class="dropdown-menu__icon">
                                <img src="img/avatar.png" alt="" srcset="">
                            </span>
                            <div class="dropdown-menu--title">Utilizador 1</div>
                            <div class="dropdown-menu--title">judsoncapepa22@gmail.com</div>
                        </div>
                        <ul class="dropdown-group">
                            <li class="dropdown-item">
                                <a href="#" class="dropdown-link--item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        class="eva eva-shield-outline">
                                        <g data-name="Layer 2">
                                            <g data-name="shield">
                        ...
                        <ul class="dropdown-group">
                            ...
                            <li class="dropdown-item">
                                <a href="#" class="dropdown-link--item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        class="eva eva-credit-card-outline">
                                        <g data-name="Layer 2">
                                            <g data-name="credit-card">
                                                ...
                                                <path d="M15 15h2a1 1 0 0 0 0-2h-2a1 1 0 0 0 0 2z"></path>
                                            </g>
                                        </g>
                                    </svg> Subscrição
                                </a>
        ...
        <div class="dashboard-content">
            <div class="dashbord-container">
                <div class="subscribe-flat-body">                    
                    <a href="#" class="subscribe-button">
                        <span class="subscribe-button--icon flex-c-full">
                            <svg viewBox="0 0 24 24" style="fill: #fff;">
                                <path d="M22,17H18V10H22M23,8H17A1,1 0 0,0 16,9V19A1,1 0 0,0 17,20H23A1,1 0 0,0 24,19V9A1,1 0 0,0 23,8M4,6H22V4H4A2,2 0 0,0 2,6V17H0V20H14V17H4V6Z"></path>
                            </svg>
                        </span>
                        <span class="subscribe-button--text flex-c-full">Subscrever</span>
                    </a>
                    <div class="subscribe-flat-ellipsis">
                ...
                <div class="container-header">
                    <span>Espaço de Trabalho do Malungo</span>
                    <h2>Configurações de espaço de Trabalho</h2>
                </div>
                <div class="filter flex">
                    <form action="" method="post" enctype="multipart/form-data" >            
                        <div class="filter__inputs flex-c-vert">
                            <div class="form_control">
                                <select name="month">
                                    <option value="" style=" padding: 15px 10px;">Todos os meses</option>
                                    <option value="12">Dezembro</option>
                                </select>
                            </div>
                            <div class="form_control">
                                <select name="year">
                                    <option value="">Todos os anos</option><option value="2022">2022</option>                    </select>       
                            </div>
                            <button class="filter__button flex-c-vert">
                                <svg viewBox="0 0 512 512"><path d="M35.4 87.12l168.65 196.44A16.07 16.07 0 01208 294v119.32a7.93 7.93 0 005.39 7.59l80.15 26.67A7.94 7.94 0 00304 440V294a16.07 16.07 0 014-10.44L476.6 87.12A14 14 0 00466 64H46.05A14 14 0 0035.4 87.12z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"></path></svg>
                                Filtrar
                            </button>
                        </div>
                    </form>
                </div>
                <div class="row flex m10-adjust">
                    <article class="box4 item ph-item">
                        <div class="item-images animated-background flex-c-full">
                            <img class="lzy_img ph-picture" data-src="img/edicao-335-1668558943.webp" title="">
                            <div class="item-description">
                                <div class="buttons">
                                    <span class="btns expand-button show_imgs">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="32"
                                                d="M432 320v112H320M421.8 421.77L304 304M80 192V80h112M90.2 90.23L208 208M320 80h112v112M421.77 90.2L304 208M192 432H80V320M90.23 421.8L208 304" />
                                        </svg>
                                        <span class="tooltip">Expandir</span>
                                    </span>
                                    <a class="btns btn-read" data-id="eee2079d-b0b6-4267-9812-b6b9eadb9c60">
                                        ...
                                        <span class="tooltip">Ler jornal</span>
                                    </a>
                                </div>
                                <div class="buttons extra">
                                    <span class="btns expand-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="32"
                                                d="M432 320v112H320M421.8 421.77L304 304M80 192V80h112M90.2 90.23L208 208M320 80h112v112M421.77 90.2L304 208M192 432H80V320M90.23 421.8L208 304" />
                                    ...
                                    <a class="btns extra btn-read" data-id="eee2079d-b0b6-4267-9812-b6b9eadb9c60">
                                        Ler jornal
                                    </a>
                                </div>
                                <h3>Edição nº: 0335</h3>
                                <span>De 12/04/2022</span>
                                <div class="price flex">
                                    <strong class="actual_price"><i>KZ</i> 1.000,00</strong>
                                </div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="box4 item">
                        <div class="item-images animated-background flex-c-full">
                            <img class="lzy_img " data-src="img/edicao-335-1668558943.webp" title="">
                            <div class="item-description">
                                <div class="buttons">
                                    <span class="btns expand-button show_imgs">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                    ...
                    <article class="box4 item">
                        <div class="item-images animated-background flex-c-full">
                            <img class="lzy_img" loading="lazy" data-src="img/edicao-335-1668558943.webp" title="">
                            <div class="item-description">
                                <div class="buttons">
                                    <span class="btns expand-button show_imgs">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                                    ...
                                    <!-- modal-open  para abrir a modal de aviso de 14 dias , e comprar outro jornal -->
                                    <a class="btns btn-read modal-open" data-target="#warning-buy">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"><path d="M368 415.86V72a24.07 24.07 0 00-24-24H72a24.07 24.07 0 00-24 24v352a40.12 40.12 0 0040 40h328" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="32"/><path d="M416 464h0a48 48 0 01-48-48V128h72a24 24 0 0124 24v264a48 48 0 01-48 48z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M240 128h64M240 192h64M112 256h192M112 320h192M112 384h192"/><path d="M176 208h-64a16 16 0 01-16-16v-64a16 16 0 0116-16h64a16 16 0 0116 16v64a16 16 0 01-16 16z"/></svg>
                                        <span class="tooltip">Ler jornal</span>
                                    </a>
                ...
                <div class="flex-c-vert pagination">
                    <div class="next-prev--buttons flex-c-vert">
                        <div class="prev-button">
                            <img src="img/left-arrow-white.png" alt="">
                            <span>Pagina <b>Anterior</b></span>
                        </div>
                        <div class="next-button">                            
                            <span><b>Proxima</b> Pagina</span>
                            <img src="img/right-arrow-black.png" alt="">
                        </div>
                    </div>
                     <div class="page-direction flex-c-vert">
                        <span class="actual-number--page">1</span>
                        <span class="total-number--page">de 231</span>
                        <div class="page-direction--buttons flex-c-vert">
                ...
                <div class="shadow_img">
                    <span class="hide flex-c-full"><svg viewBox="0 0 512 512">
        ...
        <div class="modal-pdf">
            ...
            <div id="viewer" style="width: 100%; height: 100%; margin:0px auto;"></div>
        </div>
        <div class="modal" id="warning-buy">
            
                <div class="modal-content modal-sm">
                    <div class="modal-body">
                    <span class="modal-close flex-c-full">
                        <svg viewBox="0 0 512 512">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                    </span>
                    <div class="modal-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"><path d="M448 256c0-106-86-192-192-192S64 150 64 256s86 192 192 192 192-86 192-192z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path d="M250.26 166.05L256 288l5.73-121.95a5.74 5.74 0 00-5.79-6h0a5.74 5.74 0 00-5.68 6z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path d="M256 367.91a20 20 0 1120-20 20 20 0 01-20 20z"/></svg>
                    </div>
                    <div class="modal-warning-text">
                        A sua ultima compra foi a mais de 14 dias, voce precisa adquirir pelos menos uma edição para voltar a ver os seus arquivos
                    </div>
